...
import { Eye, Megaphone, TrendingUp, Wallet, ArrowUpRight, Loader2 } from 'lucide-react';
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // Filter by using profile id stored in localStorage
  ...
  return (
    <div className="space-y-12">
      <div>
        ...
        <p className="text-slate-500 font-medium">Here's what's happening with your listings today.</p>
      </div>
