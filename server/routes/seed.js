...
const IMAGES = {
  ...
  ebony: [
    'https://i.pinimg.com/736x/d0/31/6b/d0316b2ae0840ec9419f09baf54ebf37.jpg', 'https://i.pinimg.com/736x/a1/4f/e7/a14fe7d90f1ad392130cf621b10d9cdb.jpg', 'https://i.pinimg.com/736x/9b/44/13/9b4413c7479eb84f55603cb20f6e313b.jpg', 'https://i.pinimg.com/736x/9c/de/49/9cde49c8eb6662dba355e029e2bb5b85.jpg', 'https://i.pinimg.com/736x/88/e0/51/88e051ddff892c40382e2c24f5d4c2eb.jpg', 'https://i.pinimg.com/736x/45/87/a0/4587a025a7d4cfeffcda46c0073c74a0.jpg', 'https://i.pinimg.com/736x/a0/86/d0/a086d0504027a39a1572b6855cbf3496.jpg', 'https://i.pinimg.com/736x/ce/53/8e/ce538e16d6acfc0ce1440b49360b7359.jpg', 'https://i.pinimg.com/736x/b2/f3/79/b2f3792d001cf81b39a7dbb07eae34b2.jpg', 'https://i.pinimg.com/736x/4f/db/4e/4fdb4e3c8cedb41e75f11c8b76da7851.jpg', 'https://i.pinimg.com/736x/07/ed/06/07ed0639e67db31dc7c38451d16a4440.jpg', 'https://i.pinimg.com/736x/64/c5/ca/64c5cad49a5f7c6e69e103ebfc0537f3.jpg', 'https://i.pinimg.com/736x/5b/bf/8c/5bbf8cd0ff29d9dc11070bd17f359608.jpg', 'https://i.pinimg.com/736x/fb/25/8c/fb258c6da82c0191cf8fafcc84cdf036.jpg', 'https://i.pinimg.com/736x/0e/a1/19/0ea119653acca1e69605e6218e2c3708.jpg',
  ],
};

// TEMPORARY initialization route to set up dynamic seed images table
router.get('/init-seed-images-table', async (req, res) => {
  try {
    await pool.query(`
    ...
    await pool.query('TRUNCATE TABLE seed_images');

    let count = 0;
    for (const [category, urls] of Object.entries(IMAGES)) {
      for (const url of urls) {
        await pool.query('INSERT INTO seed_images (category, url) VALUES (?, ?)', [category, url]);
        count++;
      }
    }
    res.json({ status: 'Success', imagesInserted: count });
  } catch (err) {
    res.status(500).json({ status: 'Error', error: err.sqlMessage || err.message, stack: err.stack });
  }
});
